...
<form action="friend_requests.php" method="POST">
	<input type="submit" name="acceptrequest<?php echo $user_from; ?>" value="ACCEPT REQUEST" style="background-color: #dce5ee; border: 1px solid #666; color: #666; height: 30px; width: 200px;"/>
	<input type="submit" name="ignorerequest<?php echo $user_from; ?>" value="IGNORE REQUEST" style="background-color: #dce5ee; border: 1px solid #666; color: #666; height: 30px; width: 200px;"/>
